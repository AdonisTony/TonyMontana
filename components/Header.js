...
const items = [
    { icon: 'fab fa-youtube', link: 'https://www.youtube.com/@adonistony' },
    { icon: 'fab fa-discord', link: 'https://discord.com/users/443389897298935818' },
    { icon: 'fab fa-instagram', link: 'https://instagram.com/adonistonyy' },
  ]
